...
- The mini-omega-lock empirical preflight probe suite — judge consistency,
  endpoint schema reliability, context-budget margin, latency, and noise floor
- All source code under `src/mini_omega_lock/`
- Test suite under `tests/`
- Documentation (README, EASY_README, EASY_README_KR)
- Adapter plumbing mapping probe outputs to omegaprompt's `PreflightReport` contract

This project is a sub-tool of the [omegaprompt](https://github.com/hibou04-ops/omegaprompt)
calibration framework, authored by the same Primary Author. See
[PRE_EXISTING_IP.md](PRE_EXISTING_IP.md) for the full toolkit binding.
